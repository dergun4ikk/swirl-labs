...
| will evaluate to TRUE, however if neither are TRUE, then the
...
| arguments. The xor() function stands for exclusive OR. If one argument
| evaluates to TRUE and one argument evaluates to FALSE, then this
| function will return TRUE, otherwise it will return FALSE. Try out the
| xor() function by typing: xor(5 == 6, !FALSE)
